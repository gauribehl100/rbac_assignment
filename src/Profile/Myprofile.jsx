...
function Myprofile() {
  ...
  return (
    <div>
      <h6 className="bg-blue-200 text-black text-center py-2 rounded-t-lg text-xl font-bold shadow-lg">
  MY PROFILE
</h6>
    <div className='flex flex-col md:flex-row justify-center items-center h-screen bg-gray-100'>
      <div className='bg-white p-6 rounded-lg shadow-lg max-w-sm mx-auto mb-3 md:mb-0 -mr-28 h-[50%] w-[60%]'>
      ...
      <div className='bg-white p-6 rounded-lg shadow-lg max-w-sm mx-auto h-[50%] w-[60%]'>
